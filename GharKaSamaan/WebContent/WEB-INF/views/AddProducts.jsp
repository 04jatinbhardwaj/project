...
<body>
     ...
     <div class="container col-4">
		...
		<sf:input class="form-control form-control-sm" path="prodName"/>
		<sf:errors path="prodName" cssClass="errorName"></sf:errors><br><br>
		</div>
		...
		<sf:input class="form-control form-control-sm" path="prodDesc"/>
		<sf:errors path="prodDesc" cssClass="errorName"></sf:errors><br><br>
		</div>
		
		<%-- <div class="form-group row align-items-center">
		<sf:label class="col-4 col-form-label-sm text-right" path="prodcat">Add Category </sf:label>
		<div class="dropdown">
